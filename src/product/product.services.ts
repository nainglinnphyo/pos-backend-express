...
export class Product {
  ...
  async createProdcut({ product_code, product_name, category_id, unit_id, purchase_price, pirce_data, callback }) {
    console.log(pirce_data)
  ...
  async fetchPriceListWithoutProduct({ callback }) {
    await price.findMany()
      .then((data) => callback(null, data))
      .catch((err) => callback(err, null))
  }
